...
data_folder = "/home/pi/models/"
if not detectModel:
    model_path = data_folder + "lite-model_imagenet_mobilenet_v3_large_075_224_classification_5_metadata_1.tflite"
    labels = utils.load_labels("/home/pi/labels/imageNetLabels.txt")

elif detectModel == True:

    model_path = data_folder + "sicbV8.tflite"
    labels = utils.load_labels("/home/pi/sicbV8_labels.txt")
